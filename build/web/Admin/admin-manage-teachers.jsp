...
<html>
    ...
    <div class="container mt-5">        
        ...
        %>
                <div class="card-body ">
                    <button type="button" onclick="window.location.href='process-add-teacher.jsp'" class="btn btn-flex btn btn-primary mb-3"><b>Add Teacher</b></button>
                                ...
                                <%
                                    if(teacherList.size() > 0) {
                                        for(int i = 0; i < teacherList.size(); i++) {
                                            ...
                                            out.print("<button type='button' class='btn btn-success btn-sm btn-edit btn-flex' onclick=\"window.location.href='process-update-teacher.jsp?id=" + teacherList.get(i).getTeacherID() + "'\"><b>Edit</b></button>");
                                            out.print("<button type='submit' name='action' value='delete' onclick=\"return confirm('Are you sure you want to remove this teacher?')\"  class='btn btn-danger btn-sm btn-flex' form='my_form" + (i+1) +"'><b>Delete</b></button>");
                                            out.print("</div>");
                                            out.print("</td>");
                                            out.print("</tr>");
                                       }
                                    } else {
                                         out.print("<tr class='no-register'><td colspan='5'>No registered teachers</td></tr>");
                                    }                     
                                %>                           
                            </tbody>
                       </table>
